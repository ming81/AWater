...
Shader "Carava/MiniPBR/PBR_Metallic_Cartoon_ArkCustom_Hair"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			#include "/Include/ArkCartoonHair.cginc"
			...
			half4 frag (VertexOutput i) : SV_Target
			{
				...
				{
					adjustedNdotL = saturate(dot(f_normalWorld, f_lightDirWorld));
				}
				...
				// 增加matcap
				f_finalColor = ApplyMatCap(f_finalColor, i.uv0, i.normalDir, tangentTransform, f_viewDirWorld, f_lightColor);
